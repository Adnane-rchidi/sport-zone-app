...
<head>
    ...
    <title>Manage Sports - Admin - SportZone</title>
    ...
    <div class="container main-content">
        <div class="content-container">
            ...
            <div class="d-flex justify-content-between align-items-center mb-4">
                ...
                <a href="ajouter_sport.php" class="btn btn-add-new">
                    <i class="fas fa-plus-circle"></i> Add New Sport
                </a>
            </div>
                            ...
                            <?php foreach ($sports as $sport): ?>
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a href="modifier_sport.php?id=<?= $sport['id'] ?>" class="btn btn-edit me-2">
                                            <i class="fas fa-edit"></i> Edit
                                        </a>
                                        <a href="supprimer_sport.php?id=<?= $sport['id'] ?>" class="btn btn-delete" onclick="return confirm('Are you sure you want to delete this sport?');">
